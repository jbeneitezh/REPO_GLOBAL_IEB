...
public class VolatilitySurface extends Thread {
	...
	public String rutaOutput(String code, String title) {
	...
	private void procesaMatriz(Statement sta) {
		for (int i=1;i<matrizDatos.length;i++) {
			...
			if(tasaR!=-100) {
				...
				double vol85=Double.parseDouble(matrizDatos[i][2].replace("%", ""));
				double vol90=Double.parseDouble(matrizDatos[i][3].replace("%", ""));
				double vol95=Double.parseDouble(matrizDatos[i][4].replace("%", ""));
				double vol100=Double.parseDouble(matrizDatos[i][5].replace("%", ""));
				double vol105=Double.parseDouble(matrizDatos[i][6].replace("%", ""));
				double vol110=Double.parseDouble(matrizDatos[i][7].replace("%", ""));
				double vol115=Double.parseDouble(matrizDatos[i][8].replace("%", ""));
				double vol120=Double.parseDouble(matrizDatos[i][9].replace("%", ""));

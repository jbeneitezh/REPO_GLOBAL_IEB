...
public class InfoSQL {
	...
	public static String RutaCarpetaLogs(){
		return RutaAplicacion()+"\\logs";
	}
	public static String LogOperaciones(){
		return RutaCarpetaLogs()+"\\Operaciones_"+FechaSimple.FechaSistemaString()+".txt";
	}
	public static String LogErrores() {
		return RutaCarpetaLogs()+"\\Errores_"+FechaSimple.FechaSistemaString()+".txt";
	}
	public static String LogCritical(){
		return RutaCarpetaLogs()+"\\Critical_"+FechaSimple.FechaSistemaString()+".txt";
	}
	public static String RutaLevantaWamp(){
		return RutaAplicacion()+"\\bat\\Levanta_Wamp.bat";
	}
	public static String RutaExports(){
		return RutaAplicacion()+"\\exports_bbdd";
	}
	public static String mailReceiver(){
		return "jbeneitezh@gmail.com";
	}
